...
You can log into the administration console for the Identity Service by navigating to `identity.{domain-name}/auth` and using the username **admin** and password of **admin**.
