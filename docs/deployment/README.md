...
* Using Terraform: 
	* [Deployment with Rancher on Amazon EKS](#terraform-deployment-with-rancher-on-amazon-eks)
	* [Deployment on Amazon EKS](#terraform-deployment-on-amazon-eks)
	* [Deployment into an existing Kubernetes cluster](#terraform-deployment-into-an-existing-kubernetes-cluster)
	
* [Using Helm charts]()

## Prerequisites
The following are the prerequisites for deploying Activiti Enterprise. Option specific prerequisites are described in the relevant sections:  

* [Quay.io](https://quay.io) credentials to access Activiti Enterprise images. 
* A valid license for Activiti Enterprise. 


## Terraform deployment with Rancher on Amazon EKS 

### Prerequisites
The Rancher on Amazon EKS deployment assumes that you have the following already set up:
...
## Terraform deployment on Amazon EKS


### Prerequisites
The Amazon EKS deployment assumes that you have the following already set up:
...
## Terraform deployment into an existing Kubernetes cluster
...
* A Docker registry.
* A Kubernetes cluster using *version 1.12*
* Terraform *version 0.11*
